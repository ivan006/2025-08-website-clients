<template>
  <div class="q-pa-md bg-grey-1x" style="">
    ...
    >
      <div class="q-pa-lg">
        <div class="text-h6 text-weight-bold q-mb-md">Thank you</div>

        <div class="text-body1 q-mb-md">Your order has been received.</div>

        <div class="text-body2 q-mb-lg">
          If your payment was successful, you’ll receive a confirmation email
          shortly. A separate shipping quote will be provided once your order
          has been processed.
        </div>
