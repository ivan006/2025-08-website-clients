    ...
    <q-dialog v-model="show">
      ...
      >
        ...
        <q-card-section>
          ...
          <q-banner class="q-mt-md bg-grey-2 text-grey-9" rounded dense>
            <template #avatar>
              <q-icon name="info" color="primary" />
            </template>

            <div class="text-caption">
              After deleting cached entries, you may need to perform a
              <strong>hard refresh</strong>
              to ensure your browser loads the latest content.
              <br /><br />

              <strong>Hard refresh shortcuts:</strong><br />
              • <strong>Windows:</strong> Ctrl + Shift + R &nbsp;or&nbsp; Ctrl +
              F5<br />
