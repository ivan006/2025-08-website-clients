            ...
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <div class="q-pa-lg">
                        ...
                        <template
                            v-else-if="
                                !['For Sale', 'Details Pending'].includes(
                                    product.Status,
                                )
                            "
                        >
                            ...
                            <div class="text-body2 q-mb-lg">
                                Sorry, this product is no longer available for
                                purchase.
                            </div>
                        ...
                        <template v-else>
                            <div class="" @pointerdown="clearErrors">
                                ...
                                <!-- Contact info -->
                                <div
                                    class="text-subtitle2 text-weight-medium q-mb-sm"
                                >
                                    Contact information
                                </div>
                                ...
                                <NativeLikeValidationError
                                    class="q-mb-sm"
                                    :errors="errors.addr_street"
                                />

                                <q-input
                                    v-model="form.addr_unit"
                                ...
                                <div class="row q-col-gutter-sm q-mb-sm">
                                    <div class="col-6">
                                        ...
                                        <NativeLikeValidationError
                                            class="q-mb-sm"
                                            :errors="errors.addr_city"
                                        />
                                    </div>
                                    <div class="col-6">
                                        <q-input
                                            v-model="form.addr_region"
                                ...
                                >
                                    <div class="text-body2">
                                        ...
                                        After your order is processed, you will
                                        receive a separate shipping quote.
                                    </div>
                                </q-banner>
                                <q-banner
                                    v-if="checkoutError"
                                ...
                                <div
                                    class="text-caption text-grey text-center q-mt-sm"
                                >
                                    You will be redirected to PayFast to
                                    complete payment
                                </div>
                            </div>
                        </template>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                delivery_name: [(v) => !!v || "Please fill in this field."],
                delivery_email: [
        ...
        async submit() {
            ...
            try {
                ...
                const orderRes = await fetch(
                    `${
                        import.meta.env.VITE_API_PAY_INTEGRATION_URL
                ...
                if (!orderRes.ok) {
                    throw new Error(
                        orderRes.error || "Failed to generate order",
                    );
                }
                ...
                if (!confirmRes.ok) {
                    ...
                    throw new Error(
                        confirmRes.error || "Failed to confirm price",
                    );
                }

                // 3️⃣ Redirect to PayFast
                this.redirectToPayFast(
                    confirmRes.payfast_url,
                    confirmRes.fields,
                );
            } catch (err) {
                console.error(err);
