              ...
              <div class="col-12 col-md-4">
                ...
                >
                  <q-card-section>
                    ...
                    <p class="q-mt-xs">
                      Monday to Saturday<br />11:00 PM – 5:00 AM
                    </p>
                  </q-card-section>
                </q-card>
              </div>
              ...
              <div class="col-12 col-md-4">
                ...
                >
                  <q-card-section>
                    ...
                    <p class="q-mt-xs">
                      123 Main Road, Cape Town<br />(see map below 👇)
                    </p>
                  </q-card-section>
                </q-card>
              </div>
