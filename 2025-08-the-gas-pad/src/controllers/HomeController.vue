...
export default {
  ...
  //       image = `https://thegaspad.co.za/integrator/data-cache/index.php?url=${encodeURIComponent(this.item?.['Image']?.[0]?.url)}`;
  //       image = `https://thegaspad.co.za/integrator/data-cache/index.php?url=${encodeURIComponent(this.item?.fields?.['Image']?.[0]?.url)}`;
  //     }
